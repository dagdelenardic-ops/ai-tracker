...
export default function Header() {
  const { searchQuery, setSearchQuery, refreshData, loading, favorites, setActiveCategory } = useApp();
        ...
        <div className="flex items-center justify-between h-16 lg:h-20">
          ...
          >
            ...
            <div className="text-left pointer-events-none">
              <h1 className="text-xl lg:text-2xl font-bold gradient-text group-hover:opacity-80 transition-opacity">
                AI Tracker
              </h1>
